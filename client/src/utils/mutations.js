...
export const ADD_TO_CART = gql`
  mutation addToCart($userId: ID!, $stripeProductId: String!, $price: Int!, $name: String!) {
    addToCart(userId: $userId, stripeProductId: $stripeProductId, price: $price, name: $name) {
      _id
      userId
      items {
        name
