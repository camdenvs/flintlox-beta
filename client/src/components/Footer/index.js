        ...
        <footer>
            <Box display={'flex'} height={'100px'} justifyContent={'space-evenly'} marginTop={'25px'}>
                ...
                <Box display={'flex'} alignSelf={'center'}>
                    <Link href='https://www.instagram.com/flintloxleathergoods/'><FaInstagram size={'50px'} /></Link>
                    <Link href='https://twitter.com/flintloxleather'><Image src="/images/x-twitter.svg" marginX='20px' width={'50px'}/></Link>
